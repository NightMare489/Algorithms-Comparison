...
#  endif
    ...
    inline void set_xlabel(const std::string& str, const std::map<std::string, std::string>& keywords = {})
    {
        ...
        PyObject* zlabel = PyObject_GetAttrString(ax, "set_xlabel");
        if (!zlabel) throw std::runtime_error("Attribute set_xlabel not found.");
        Py_INCREF(zlabel);
    ...
    inline void set_ylabel(const std::string& str, const std::map<std::string, std::string>& keywords = {})
    {
        ...
        PyObject* zlabel = PyObject_GetAttrString(ax, "set_ylabel");
        if (!zlabel) throw std::runtime_error("Attribute set_ylabel not found.");
        Py_INCREF(zlabel);
    ...
    inline void set_title(const std::string& str, const std::map<std::string, std::string>& keywords = {})
    {
        detail::_interpreter::get();
        ...
        PyObject* zlabel = PyObject_GetAttrString(ax, "set_title");
        if (!zlabel) throw std::runtime_error("Attribute set_title not found.");
        Py_INCREF(zlabel);
